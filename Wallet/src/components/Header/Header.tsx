...
export const Header: React.FunctionComponent = () => {  
   ...
   const doLogOut = (e: React.NouseEvent) => {  
      e.preventDefault();  
      ...
      <header className="ecl-site-header-harmonised--group1 ecl-site-header-harmonised">  
         ...
         <div className="ecl-site-header-harmonised__top">  
           <Link
            ...
            to="/profile"  
            aria-label="SiGG Commission"  
         > 
           <img   
             alt="SiGG Commission logo"
             title="SiGG Commission"  
        ...
        <div className="ecl-container ecl-menu__container">
            ...
            <div className="ecl-menu__site-name">SiGG Wallet</div>
