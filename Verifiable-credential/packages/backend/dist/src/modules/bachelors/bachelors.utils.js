...
const bachelor_diploma_structure_json_1 = __importDefault(require("./bachelor-diploma-structure.json"));
function formatVerifiableAttestation(raw, issuerDid) {
    if (!raw || !issuerDid) {
        throw new Error("Missing parameters in formatVerifiableId function");
    }
    const verifiableId = Object.assign({}, bachelor_diploma_structure_json_1.default);
...
//# sourceMappingURL=bachelors.utils.js.map