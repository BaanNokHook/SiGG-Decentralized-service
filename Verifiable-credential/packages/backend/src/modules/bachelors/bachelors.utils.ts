...
import bachelorsDiplomaStructure from "./bachelor-diploma-structure.json";
  ...
  const verifiableIdCredentialPayload = {
    ...
    vc: {
      "@context": [
        ...
        "https://SiGG-WEBSITE.TH/schemas/vc/2019/v1#",
        "https://SiGG-WEBSITE.TH/schemas/eidas/2019/v1#",
      ],
      id: verifiableId.id,
