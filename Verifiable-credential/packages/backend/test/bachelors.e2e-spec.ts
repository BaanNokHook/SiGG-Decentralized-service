...
const verifiableAttestationsEndpoint = "/api/bachelors/verifiable-attestations";
const didAuthEndpoint = "/api/bachelors/did-auth";
const didAuthValidationsEndpoint = "/api/bachelors/did-auth-validations";
