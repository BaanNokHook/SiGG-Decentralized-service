const { REACT_APP_SiGG_ENV, PUBLIC_URL } = process.env;
...
const defaultConfig = {
  local: {
    REACT_APP_BACKEND_EXTERNAL_URL: "http://localhost:8080/demo/diploma",
    REACT_APP_WALLET_WEB_CLIENT_URL: "https://app.intSiGG.xyz/wallet",
    REACT_APP_DEMONSTRATOR_URL: "https://app.intSiGG.xyz/demo",
  },
  integration: {
    REACT_APP_BACKEND_EXTERNAL_URL: "https://app.intSiGG.xyz/demo/diploma",
    REACT_APP_WALLET_WEB_CLIENT_URL: "https://app.intSiGG.xyz/wallet",
    REACT_APP_DEMONSTRATOR_URL: "https://app.intSiGG.xyz/demo",
  },
  development: {
    REACT_APP_BACKEND_EXTERNAL_URL: "https://app.SiGG.xyz/demo/diploma",
    REACT_APP_WALLET_WEB_CLIENT_URL: "https://app.SiGG.xyz/wallet",
    REACT_APP_DEMONSTRATOR_URL: "https://app.SiGG.xyz/demo",
  },
  production: {
...
const config = {
  ...
  REACT_APP_DEMONSTRATOR_URL:
    ...
    defaultConfig[REACT_APP_SiGG_ENV].REACT_APP_DEMONSTRATOR_URL,
  REACT_APP_BACKEND_EXTERNAL_URL:
    process.env.REACT_APP_BACKEND_EXTERNAL_URL ||
    defaultConfig[REACT_APP_SiGG_ENV].REACT_APP_BACKEND_EXTERNAL_URL,
};
