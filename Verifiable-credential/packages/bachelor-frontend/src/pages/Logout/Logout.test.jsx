...
describe("logout", () => {
  ...
  it("renders correctly when the user is authenticated", () => {
    ...
    localStorage.setItem("Bachelor-JWT", token);
    ...
    expect(component.toJSON()).toMatchInlineSnapshot(`
      Array [
        <h1
          className="ecl-page-header-harmonised__title ecl-u-mt-xl ecl-u-mb-xl"
        >
          Log out
        </h1>,
        <p
        ...
        >
          You are about to log out from the simulated authentication system of the Sample University - Bachelor's Programme.
        </p>,
        <button
